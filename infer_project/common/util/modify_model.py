...
def main(args):
    pt_model = attempt_load(args.pt_path, device='cpu')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pt_path', type=str, default='./yolov5s.pt', help='pt_model path')
    parser.add_argument('--onnx_path', type=str, default='./yolov5s.onnx', help='onnx_model path')
    ...
    parser.add_argument('--class_num', type=int, default=80, help='class num')
